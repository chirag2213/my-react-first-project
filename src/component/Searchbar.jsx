...
const Searchbar = ({searchText, setSearchText, masterList, updateRestaurantList}) => {
    ...
    return(
        <div className='mx-5 my-5 border w-full max-w-xs border-black relative '>
          <input className=" w-full p-2 border-none rounded h-full p-2" type="text" placeholder="Enter Restaurant Name" value={searchText} onChange={(e) => handleSearchText(e.target.value)}/>
